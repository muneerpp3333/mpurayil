...
export default function TemplateDetailClient({ template, related }: TemplateDetailClientProps) {
  const faqs = [
    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pt-20">
      ...
      <div className="px-6 pt-8 pb-4">
        <div className="max-w-[1200px] mx-auto">
          <Link href="/templates" className="inline-flex items-center gap-2 text-[10px] font-mono uppercase tracking-widest text-white/30 hover:text-white/60 transition-colors">
