...
export default function Portfolio() {
  ...
  return (
    ...
    >
      <SEOHead
        title="Portfolio | Muneer Puthiya Purayil"
        description="Architecture decisions and their measurable outcomes across fintech, automotive, e-commerce, and healthcare. $4B platforms, sub-0.1% crash rates, 300% efficiency gains."
